                    ...
                    <div className="page" style={{ backgroundImage: `url(${background1})` }} >
                        ...
                        <section class="okay">
                            <Navbar collapseOnSelect expand="lg" className="main-nav" id="navbar" >
                                <Container>
                                    <Navbar.Brand as={Link} to={`/directorDashboard/${email1}`}>
                                        <img
                                            src={logo}
                                            height="50"
                                    ...
                                    <Nav.Link as={Link} to={`/directorDashboard/${email1}`} className="active">Director Dashboard</Nav.Link>
                                    ...
                                    <Navbar.Collapse id="navbarsExample09" className="justify-content-end">
                                        <Nav className="ml-auto">
                                            ...
                                            <NavDropdown title="Settings" id="dropdown02" className="active">
                                                <NavDropdown.Item as={Link} to={`/directorDashboard/${email1}/directorResetPassword`}>Reset Password</NavDropdown.Item>
                                                <NavDropdown.Item as={Link} to={`/directorDashboard/${email1}/directorEditInfo`}>Update Informations</NavDropdown.Item>
                                            </NavDropdown>
                                            <Nav.Link as={Link} to={`/directorDashboard/${email1}`} className="active">Back</Nav.Link>
