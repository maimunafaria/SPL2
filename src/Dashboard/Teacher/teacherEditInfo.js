                    ...
                    <div className="page" style={{ backgroundImage: `url(${background1})` }} >
                        ...
                        <section class="okay">
                            <Navbar collapseOnSelect expand="lg" className="main-nav" id="navbar" >
                                <Container>
                                    <Navbar.Brand as={Link} to={`/teacherDashboard/${email1}`}>
                                        <img
                                            src={logo}
                                            height="50"
                                    ...
                                    <Nav.Link as={Link} to={`/teacherDashboard/${email1}`} className="active">Teacher Dashboard</Nav.Link>
                                    ...
                                    <Navbar.Collapse id="navbarsExample09" className="justify-content-end">
                                        <Nav className="ml-auto">
                                            ...
                                            <NavDropdown title="Settings" id="dropdown02" className="active">
                                                <NavDropdown.Item as={Link} to={`/teacherDashboard/${email1}/teacherResetPassword`}>Reset Password</NavDropdown.Item>
                                                <NavDropdown.Item as={Link} to={`/teacherDashboard/${email1}/teacherEditInfo`}>Update Informations</NavDropdown.Item>
                                            </NavDropdown>
                                            <Nav.Link as={Link} to={`/teacherDashboard/${email1}`} className="active">Back</Nav.Link>
