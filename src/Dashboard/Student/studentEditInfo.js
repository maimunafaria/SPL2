                    ...
                    <div className="page" style={{ backgroundImage: `url(${background1})` }} >
                        ...
                        <section class="okay">
                            <Navbar collapseOnSelect expand="lg" className="main-nav" id="navbar" >
                                <Container>
                                    <Navbar.Brand as={Link} to={`/studentDashboard/${email1}`} >
                                        <img
                                            src={logo}
                                            height="50"
                                    ...
                                    <Nav.Link as={Link} to={`/studentDashboard/${email1}`} className="active">Student Dashboard</Nav.Link>
                                    ...
                                    <Navbar.Collapse id="navbarsExample09" className="justify-content-end">
                                        <Nav className="ml-auto">
                                            ...
                                            <NavDropdown title="Settings" id="dropdown02" className="active">
                                                <NavDropdown.Item as={Link} to={`/studentDashboard/${email1}/studentResetPassword`}>Reset Password</NavDropdown.Item>
                                                <NavDropdown.Item as={Link} to={`/studentDashboard/${email1}/studentEditInfo`}>Update Informations</NavDropdown.Item>
                                            </NavDropdown>
                                            <Nav.Link as={Link} to={`/studentDashboard/${email1}`} className="active">Back</Nav.Link>
